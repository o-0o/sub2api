export default {
  ...
  imageGen: {
    ...
    subtitle: 'Generate professional images with GPT Image 2',
    yourBalance: 'Your Balance',
    estimatedCost: 'Estimated Cost',
    templates: 'Templates',
    categoryAll: 'All',
    categoryInfographic: 'Infographic',
    ...
    customPromptPlaceholder: 'Optional: Enter custom prompt to override template default',
    size: 'Image Size',
    ...
    referenceImageHint: 'Supports JPG/PNG, max 10MB',
    noApiKey: 'Please create an API key first',
