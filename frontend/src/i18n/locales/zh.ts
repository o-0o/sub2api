export default {
  ...
  imageGen: {
    title: '图片生成',
    subtitle: '使用 GPT Image 2 生成专业图片',
    yourBalance: '您的余额',
    estimatedCost: '预估费用',
    templates: '模板选择',
    categoryAll: '全部',
    categoryInfographic: '信息图',
    categoryPoster: '海报',
    categoryUI: 'UI界面',
    ...
    customPrompt: '自定义提示词',
    customPromptPlaceholder: '可选：输入自定义提示词，覆盖模板默认提示词',
    size: '图片尺寸',
    quality: '图片质量',
    n: '生成数量',
    generate: '生成图片',
    ...
    referenceImageHint: '支持 JPG/PNG，最大 10MB',
    noApiKey: '请先创建 API 密钥',
    balanceInsufficient: '余额不足，无法生成图片',
    error: '生成失败',
    success: '图片生成成功'
  },
